...
public class DienThoai implements java.io.Serializable {
	...
	public DienThoai(int maDt, DanhMuc danhMuc, NhaSanXuat nhaSanXuat, String tenDt, int giaBan, int tonKho,
			int giamGia) {
		this.maDt = maDt;
	...
	public DienThoai(int maDt, DanhMuc danhMuc, NhaSanXuat nhaSanXuat, String tenDt, byte[] hinhAnh,
			...
			String sim, String pin, int giaBan, int tonKho, int giamGia) {
		this.maDt = maDt;
		this.danhMuc = danhMuc;
		this.nhaSanXuat = nhaSanXuat;
		this.tenDt = tenDt;
